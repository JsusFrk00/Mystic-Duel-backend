        ...
        if (matchmakingQueue.length > 0) {
            ...
            if (opponent) {
                ...
                activeGames.set(gameId, {
                    player1: { id: socket.id, socket: socket },
                    player2: { id: opponentId, socket: opponent },
            ...
            activeGames.forEach((game, gameId) => {
                if (game.player1.id === socket.id || game.player2.id === socket.id) {
                    ...
                    if (isPlayer1) {
                        ...
                        console.log('  Player 1 deck selected:', data.deck?.length, 'cards');
                    } else {
                        game.player2.deck = data.deck;
                        game.player2.ready = true;
                        console.log('  Player 2 deck selected:', data.deck?.length, 'cards');
                    }
